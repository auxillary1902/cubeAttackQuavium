...
class Parser():
    def __init__(self):
        ...
        parser.add_argument("--mode", default="trivium", choices=["random", "trivium","quavium"],
                            help="What polynomial to perform the attack on ?\
                                  a random polynomial or trivium or quavium ?")

        parser.add_argument("--n_rounds", default=672, type=int,
                            help="number of initialisation rounds for trivium/quavium?")
